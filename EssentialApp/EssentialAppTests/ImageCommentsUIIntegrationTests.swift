...
class ImageCommentsUIIntegrationTests: XCTestCase {
    ...
    func test_loadFeedCompletion_rendersSuccessfullyLoadedFeed() {
        let comment0 = makeImageComment(message: "a message", username: "a username")
    ...
    func test_loadCommentsCompletion_rendersSuccessfullyLoadedEmptyCommentsAfterNonEmptyFeed() {
        let comment = makeImageComment(message: "a message", username: "a username")
        let (sut, loader) = makeSUT()
    ...
    private func makeImageComment(message: String = "a message", username: String = "a username") -> ImageComment {
